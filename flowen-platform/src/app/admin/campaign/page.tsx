    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-6 border-b border-slate-800">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Parliamentary petition, influencers, press, MPs</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: 'Petition Signatures', value: '—' },
          { label: 'MPs Contacted', value: '—' },
          { label: 'Press Mentions', value: '—' },
        ].map((stat) => (
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
        ...
        <p className="text-slate-400 text-sm leading-relaxed">
          This section will coordinate the parliamentary petition campaign, track MP outreach
          and responses, manage influencer partnerships and content approval, monitor press
          coverage, and provide a campaign calendar with milestone tracking toward NHS adoption goals.
        </p>
      </div>
    </div>
  );
