  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-6 border-b border-slate-200 dark:border-slate-800">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Campaign</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5">
          ...
          <p className="text-3xl font-black text-slate-900 dark:text-white">{achieved}<span className="text-slate-600 text-lg font-bold">/{milestones.length}</span></p>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5">
          ...
          <p className="text-3xl font-black text-slate-900 dark:text-white">{contacts.length}</p>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5">
          ...
          <p className="text-3xl font-black text-slate-900 dark:text-white">{press.length}</p>
