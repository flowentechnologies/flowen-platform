...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      `default-src 'self'`,
      `script-src 'self' 'unsafe-inline' https://js.stripe.com https://cdn.jsdelivr.net https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://analytics.tiktok.com https://snap.licdn.com https://static.hotjar.com https://www.clarity.ms https://static.ads-twitter.com`,
      `style-src 'self' 'unsafe-inline'`,
      `img-src 'self' data: blob: https:`,
      `font-src 'self' data:`,
      // Sentry tunnel proxies browser events through /monitoring — no external ingest needed
      `connect-src 'self' ${SUPABASE_URL} wss://*.supabase.co https://*.supabase.co https://api.stripe.com https://*.google-analytics.com https://analytics.google.com https://*.analytics.google.com https://*.facebook.com https://analytics.tiktok.com https://px.ads.linkedin.com https://static.ads-twitter.com https://*.hotjar.com https://www.clarity.ms`,
