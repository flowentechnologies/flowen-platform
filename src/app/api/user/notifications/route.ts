...
export async function POST(request: Request) {
  ...
  if (typeof body.email_reminders === 'boolean') updates.email_reminders = body.email_reminders;
  if (typeof body.streak_notifications === 'boolean') updates.streak_notifications = body.streak_notifications;
