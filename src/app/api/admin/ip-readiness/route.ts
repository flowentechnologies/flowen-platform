...
const SEED_AUDIT: Omit<AuditItem, 'id' | 'created_at' | 'updated_at'>[] = [
  ...
  // AI Models
  { category: 'ai_models', title: 'ASR Model IP Assignment from Founders', description: 'Ensure all IP in the core ASR model is formally assigned from founders to Flowen Group Ltd', status: 'not_started', risk_level: 'critical', priority: 1, assignee: null, due_date: null, evidence_url: null, notes: 'Critical for investor diligence — must be complete before term sheet' },
