          ...
          <div>
            ...
            <div className="mt-4 flex items-start gap-3 bg-slate-900/70 border border-slate-800 rounded-xl px-4 py-3">
              ...
              <p className="text-slate-400 text-xs leading-relaxed">
                <span className="text-slate-200 font-semibold">Why we collect this:</span> Flowen is assessed under the UK&apos;s Digital Technology Assessment Criteria (DTAC) for NHS clinical platforms. Age verification and address are required to comply with DCB0129 clinical safety standards. Your data is never sold or shared with third parties.
              </p>
            </div>
          </div>
