...
const TIER_STYLES: Record<Tier, string> = {
  ...
  standard: 'bg-slate-700/60 text-slate-300 border border-slate-600',
...
function FlagForm({ editing, onSubmit, onCancel, submitting }: FlagFormProps) {
  ...
  return (
    <div className="rounded-xl border border-slate-700 bg-slate-900 p-6 mt-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full rounded-lg border px-3 py-2 text-xs font-mono bg-slate-800 text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 ${
                !isCreate
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-700 hover:border-slate-600 px-3 py-2 text-xs bg-slate-800 text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-slate-700 hover:border-slate-600 px-3 py-2 text-xs bg-slate-800 text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 resize-none"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-24 rounded-lg border border-slate-700 hover:border-slate-600 px-3 py-2 text-xs bg-slate-800 text-white focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500"
          />
            ...
            {ALL_TIERS.map((tier) => (
              <label key={tier} className="flex items-center gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="w-3.5 h-3.5 rounded border-slate-600 bg-slate-800 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-slate-900"
                />
        ...
        <div className="flex items-center gap-3 pt-2 border-t border-slate-800">
          <button
            type="submit"
            disabled={submitting}
            className="px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
                          ...
                          {flag.allowed_tiers.map((tier) => (
                            <span
                              ...
                              className={`px-1.5 py-0.5 rounded-full text-[10px] font-medium ${
                                TIER_STYLES[tier as Tier] ?? 'bg-slate-700/60 text-slate-300 border border-slate-600'
                              }`}
                            >
                              {tier}
                            </span>
                      ...
                      {confirmDeleteId === flag.id ? (
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            ...
                            className="px-2 py-0.5 rounded text-[10px] bg-slate-700 text-slate-300 hover:bg-slate-600 transition-colors"
                          >
                            No
                          </button>
                        </div>
