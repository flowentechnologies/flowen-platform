    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-6 border-b border-slate-800">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Investor due diligence vault</p>
        </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
        ...
        <p className="text-slate-400 text-sm leading-relaxed">
          This section will provide a secure investor due diligence vault including cap table,
          financial projections, clinical evidence, IP portfolio, regulatory documents,
          NHS engagement letters, and granular access control per document per investor.
        </p>
      </div>
    </div>
  );
