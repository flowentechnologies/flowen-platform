        ...
        <div className="absolute right-0 mt-1 w-56 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl shadow-xl z-10 p-4 space-y-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={submit}
              disabled={loading}
              className="flex-1 py-1.5 text-xs font-medium bg-red-700 hover:bg-red-600 text-slate-900 dark:text-white rounded-lg transition-colors disabled:opacity-50"
            >
              {loading ? '…' : 'Confirm'}
            </button>
            <button
