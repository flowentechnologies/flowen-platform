        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-11 rounded-xl bg-[#121624] border border-slate-700 text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 text-sm"
            />
            <button
              type="button"
              tabIndex={-1}
          ...
          <p className="text-[11px] text-slate-600 mt-1.5">Minimum 8 characters</p>
        </div>
