...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      { text: 'Also in the space: StutterBox, Fluency Coach, Power Stuttering, Speako, Free From Stutter, SpeechEasy Pro, TalkSlower, Speech Bubbles, Starfish Project, Stuttering Therapist — smaller or regional stammering-support apps and services.', color: C.lav },
      { text: 'The McGuire Programme — established in-person intensive breathing-technique course, not an app; a different, offline, high-commitment category.', color: C.lav },
      { text: 'The Stuttering Foundation (stutteringhelp.org) [1] — nonprofit information and referral resource, not a commercial competitor product.', color: C.lav },
      { text: 'Nuance, acquired by Microsoft for $19.7bn [4] — general-purpose dictation/enterprise ASR, not stammering-specific; the closest large-scale M&A comparable in speech tech (see slide 14).', color: C.lav },
    ],
    accentColor: C.amber,
  },
  {
